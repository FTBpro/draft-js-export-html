...
var MarkupGenerator = function () {
  ...
  _createClass(MarkupGenerator, [{
    ...
    value: function processBlock() {
      ...
      var customRendererOutput = customRenderer && typeof customRenderer === 'function' ? customRenderer(block) : null;
    ...
    key: 'writeStartTag',
    value: function writeStartTag(blockType, customRendererOptions) {
      var tags = getTags(blockType);

      var attrString = '';
      if (customRendererOptions) {
        var _attributes = customRendererOptions && customRendererOptions.attributes;
    ...
    key: 'openWrapperTag',
    value: function openWrapperTag(wrapperTag, customRendererOptions) {
      this.wrapperTag = wrapperTag;
      this.indent();

      var attrString = '';
      if (customRendererOptions) {
        var _attributes2 = customRendererOptions && customRendererOptions.attributes;
        attrString = stringifyAttrs(_attributes2);
      }
          ...
          try {
            for (var _iterator5 = _this.styleOrder[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
              ...
              if (styleSet.has(_styleName)) {
                ...
                var _attributes3 = _inlineStyles$_styleN.attributes;
...
function isEmptyBlock(blockType) {
  switch (blockType) {
    case 'hr':
      return true;
    default:
