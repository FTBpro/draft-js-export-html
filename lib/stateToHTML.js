...
var MarkupGenerator = function () {
  ...
  _createClass(MarkupGenerator, [{
    ...
    value: function processBlock() {
      ...
      var isEmptyText = block.text.trim().length === 0;
      var isCurrentBlockAnEmptyBlock = isEmptyBlock(blockType);
    ...
    value: function writeStartTag(blockType, customRendererOptions) {
      var blockData = arguments.length <= 2 || arguments[2] === undefined ? {} : arguments[2];
